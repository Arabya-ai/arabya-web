...
# npm 11+/12 may skip install scripts unless package.json allowScripts lists them.
# Rebuild natives if sharp is missing or unloadable (common Contabo failure mode).
