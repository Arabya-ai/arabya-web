...
export default function HeritageHubPage() {
  return (
    <div className="shell page-block">
      <h1>الشعر والتراث</h1>
      <p>
        بعد القرآن والحديث: استيراد من المكتبة الشاملة ومصادر أخرى وتحليل كل كلمة
        بنفس الطبقات (صرف · نحو · دلالة · بلاغة · معجم · ترجمة).
      </p>
      <p className="layer-soon">
        جلب البيانات عبر ملفات أو استيراد/سكرابينج عند الحاجة — مع إسناد المصدر.
      </p>
      <p>
