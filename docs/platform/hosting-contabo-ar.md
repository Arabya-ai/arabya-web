...
- إن ظهر `tar TAR_ENTRY_ERROR ENOENT` أو نقص `use-intl/.../core.js` عند البناء: `docs/platform/contabo-npm-tar-enoent-ar.md`
- **لا** تشغّل `pm2 restart arabya-web` بعد فشل `npm run build` — أصلح الحزم وأعد البناء أولاً
