  ...
  return (
    <div className="shell privacy-page page-block">
      ...
      <p>
        ...
        <strong>معجم مواد عربْية</strong> (معاني دلالية قصيرة مرتبطة بجذور
        وصرف مفتوح)، مع احتياطي صرفي عند غياب المعنى. ليس إعادة نشر لترجمة
        عربية كلمة بكلمة من طرف ثالث.
      </p>
      <p>
