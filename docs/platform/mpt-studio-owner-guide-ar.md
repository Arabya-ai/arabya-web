...
ضع صور PNG أو فيديوهات MP4 في `services/money-printer-turbo/storage/local_videos/`. إن ظهرت ملفات باسم `1.png` … `9.png` فهي صور تجريبية من المحرك (أرقام للتجربة) وليست صورك. من `/studio/ai/create` اختر مصدر «ملفات محلية»، الصق سكربتًا عربيًا، وابدأ التوليد. صوت Edge TTS لا يحتاج مفتاحًا.
