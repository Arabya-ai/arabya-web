...
import { Separator } from "@/ayat-studio/components/ui/separator";
import { Sheet, SheetContent } from "@/ayat-studio/components/ui/sheet";
import { Skeleton } from "@/ayat-studio/components/ui/skeleton";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@/ayat-studio/components/ui/tooltip";
...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
 ...
 if (isMobile) {
  return (
   <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
    <SheetContent
     ...
     data-mobile="true"
     className="studio-app-sidebar w-[var(--sidebar-width)] bg-sidebar p-0 text-white [&>button]:hidden"
     style={
      {
  ...
  <div
   ...
   className="group peer relative hidden self-stretch text-white lg:block"
   data-state={state}
  ...
  >
   ...
   >
    <div
     data-sidebar="sidebar"
     className="flex h-full max-h-full w-full flex-col overflow-hidden bg-sidebar text-white group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
    >
     {children}
    </div>
   </div>
